...
export const SmallArticle4 = () => {
  return (
        ...
        <a href="single.html" target="_self"> <i className="fa fa-share-alt"></i>458</a> Likes
        </span>
                <span className="fafa-share-alt">
        <a href="single.html" target="_self"><i className="fa fa-comments-o"></i>203</a> Comments
        </span>
              </div>
            </div>
          </div>
