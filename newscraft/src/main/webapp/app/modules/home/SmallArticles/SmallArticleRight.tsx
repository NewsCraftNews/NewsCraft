    ...
    <div className="media">
      ...
      <div className="media-body">
        <h3 className="media-heading">
          <a href="/article/144" target="_self">Hawaii’s Kilauea volcano is erupting again after months of quiet</a>
        </h3>
        ...
        <div className="widget_article_social">
          <span className="fafa-share-alt">
            <a href="/article/144" target="_self">48</a> Likes
          </span>
          <span className="fafa-share-alt">
            <a href="/article/144" target="_self">13</a> Comments
          </span>
        </div>
      </div>
    </div>
