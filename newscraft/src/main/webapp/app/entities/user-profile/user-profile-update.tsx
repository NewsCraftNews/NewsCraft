  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="newsCraftApp.userProfile.home.createOrEditLabel" data-cy="UserProfileCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label="Login" id="user-profile-login" name="login" data-cy="login" type="text" />
