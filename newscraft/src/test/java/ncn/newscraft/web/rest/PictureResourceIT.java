...
class PictureResourceIT {
    ...
    public static Picture createEntity(EntityManager em) {
        Picture picture = new Picture().imageURL(DEFAULT_IMAGE_URL).caption(DEFAULT_CAPTION);
        return picture;
    }
    ...
    public static Picture createUpdatedEntity(EntityManager em) {
        Picture picture = new Picture().imageURL(UPDATED_IMAGE_URL).caption(UPDATED_CAPTION);
        return picture;
    }
    ...
    void createPicture() throws Exception {
        ...
        assertThat(testPicture.getImageURL()).isEqualTo(DEFAULT_IMAGE_URL);
    ...
    void putExistingPicture() throws Exception {
        ...
        updatedPicture.imageURL(UPDATED_IMAGE_URL).caption(UPDATED_CAPTION);
        ...
        Picture testPicture = pictureList.get(pictureList.size() - 1);
        assertThat(testPicture.getImageURL()).isEqualTo(UPDATED_IMAGE_URL);
    ...
    void fullUpdatePictureWithPatch() throws Exception {
        ...
        partialUpdatedPicture.imageURL(UPDATED_IMAGE_URL).caption(UPDATED_CAPTION);
