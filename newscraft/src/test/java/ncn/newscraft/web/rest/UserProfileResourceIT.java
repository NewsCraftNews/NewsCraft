...
class UserProfileResourceIT {
    ...
    public static UserProfile createEntity(EntityManager em) {
        UserProfile userProfile = new UserProfile().login(DEFAULT_LOGIN);
        return userProfile;
    }
    ...
    public static UserProfile createUpdatedEntity(EntityManager em) {
        UserProfile userProfile = new UserProfile().login(UPDATED_LOGIN);
        return userProfile;
    }
    ...
    void createUserProfile() throws Exception {
        ...
        assertThat(testUserProfile.getLogin()).isEqualTo(DEFAULT_LOGIN);
    }
    ...
    void putExistingUserProfile() throws Exception {
        ...
        updatedUserProfile.login(UPDATED_LOGIN);
        ...
        UserProfile testUserProfile = userProfileList.get(userProfileList.size() - 1);
        assertThat(testUserProfile.getLogin()).isEqualTo(UPDATED_LOGIN);
    }
    ...
    void fullUpdateUserProfileWithPatch() throws Exception {
        ...
        partialUpdatedUserProfile.login(UPDATED_LOGIN);
